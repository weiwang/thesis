...
social science research [@buttice_2013;@lax_2013]. In the present paper, we
...
\begin{figure*}[p!]
  \centering
  \includegraphics{alloutcomesx1.pdf}
...
\begin{figure}[p!]
  \centering
  \includegraphics{outcome234.pdf}
...
\begin{figure}[p!]
  \centering
  \includegraphics{alloutcomesxbal.pdf}
...
\begin{figure}[p!]
  \centering
  \includegraphics{hourvote_bal.pdf}
